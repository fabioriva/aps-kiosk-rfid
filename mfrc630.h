...
//#define MFRC630_PRINTF(args)    printf(args);  putch(13);
#define MFRC630_PRINTF(...)
...
extern void mfrc630_flush_fifo();
extern void mfrc630_cmd_idle();
extern uint16_t mfrc630_iso14443a_REQA();
...
uint8_t mfrc630_iso_14443A_init(void);
