...
extern Tmfrc522 mfrc522;
//	extern byte FlagNewCard;
...
void PCD_WriteRegisters(byte reg, byte count, byte* values);
byte PCD_ReadRegister(byte reg);
void PCD_ReadRegisters(byte reg, byte count, byte* values, byte rxAlign);
...
byte PCD_PerformSelfTest(void);

/////////////////////////////////////////////////////////////////////////////////////
// Functions for communicating with PICCs
/////////////////////////////////////////////////////////////////////////////////////
byte PCD_TransceiveData(byte* sendData, byte sendLen, byte* backData, byte* backLen, byte* validBits, byte rxAlign, byte checkCRC);
byte PCD_CommunicateWithPICC(byte command, byte waitIRq, byte* sendData, byte sendLen, byte* backData, byte* backLen, byte* validBits, byte rxAlign, byte checkCRC);
...
// Support functions
/////////////////////////////////////////////////////////////////////////////////////
byte PCD_MIFARE_Transceive(byte* sendData, byte sendLen, byte acceptTimeout);
// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
//const char *GetStatusCodeName(byte code);
//	static const __FlashStringHelper *GetStatusCodeName(byte code);
